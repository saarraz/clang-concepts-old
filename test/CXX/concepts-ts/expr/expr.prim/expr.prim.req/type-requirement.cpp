...
// expected-note@-1 {{because 'T::type' would be invalid: type 'int' cannot be used prior to '::' because it has no members}}
// expected-note@-2 {{because 'T::type' would be invalid: no type named 'type' in 'C'}}
...
// expected-note@-1{{because 'T::temp<int>' would be invalid: type 'int' cannot be used prior to '::' because it has no members}}
// expected-note@-2{{because 'T::temp<int>' would be invalid: no member named 'temp' in 'D'}}
// expected-note@-3{{because 'T::temp<int>' would be invalid: template name refers to non-type template 'G::template temp'}}
struct r7 {};
