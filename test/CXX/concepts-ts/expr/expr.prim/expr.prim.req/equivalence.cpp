...
struct r6;
template<typename T> requires requires { { sizeof(T) } -> decltype(sizeof(int)); } // expected-error{{requires clause differs in template redeclaration}}
struct r6;
...
struct r7;
template<typename T> requires requires { { sizeof(T) } -> const int; } // expected-error{{requires clause differs in template redeclaration}}
struct r7;
template<typename T> requires requires { { sizeof(T) } noexcept -> int; } // expected-error{{requires clause differs in template redeclaration}}
struct r7;
template<typename T> requires requires { { sizeof(T) } -> T; } // expected-error{{requires clause differs in template redeclaration}}
struct r7;
...
struct r8;
#if 0 // TODO: Concepts: Re-enable once we have placeholder constraints
template<typename T> requires requires { { sizeof(T) } -> C1 auto; } // expected-error{{requires clause differs in template redeclaration}}
struct r8;
#endif

#if 0 // TODO: Concepts: Re-enable once we have placeholder constraints
template<typename T> requires requires { { sizeof(T) } -> const volatile C1 auto; }
struct r9;
template<typename U> requires requires { { sizeof(U) } -> const volatile C1 auto; }
struct r9;
template<typename T> requires requires { { sizeof(T) } -> C1 auto const volatile; }
struct r9;
template<typename T> requires requires { { sizeof(T) } -> C1 auto volatile const; }
struct r9;
template<typename T> requires requires { { sizeof(T) } -> const C1 auto volatile; }
struct r9;
template<typename T> requires requires { { sizeof(T) } -> volatile C1 auto const; }
struct r9;
template<typename T> requires requires { { sizeof(T) } -> volatile C1 decltype(auto) const; }
struct r9;
#endif
