...
// expected-note@-3 {{because 'sizeof(char [12]) + sizeof(int [3]) + sizeof(short [6]) == 12' (36 == 12) evaluated to false}}
...
template<C3... Ts>
// expected-note@-1 {{because 'C3<char [12], int [3], short [6]>' evaluated to false}}
using D = int;
